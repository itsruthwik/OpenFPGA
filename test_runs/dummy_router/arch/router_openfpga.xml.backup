...
<openfpga_architecture>
  ...
  <circuit_library>
    ...
    <circuit_model type="hard_logic" name="router_slice" prefix="router_slice" is_default="true" spice_netlist="${OPENFPGA_PATH}/openfpga_flow/openfpga_cell_library/spice/router_slice.sp" verilog_netlist="${OPENFPGA_PATH}/openfpga_flow/openfpga_cell_library/verilog/router_slice.v">
      <design_technology type="cmos"/>
      <input_buffer exist="true" circuit_model_name="INVTX1"/>
      <output_buffer exist="true" circuit_model_name="INVTX1"/>
      <!-- <port type="input" prefix="A" lib_name="A" size="8"/>
      ...
      <port type="input" prefix="CHANNEL_IN_IP" lib_name="CHANNEL_IN_IP" size="68"/>
      <port type="input" prefix="FLOW_CTRL_IN_OP" lib_name="FLOW_CTRL_IN_OP" size="2"/>
      <port type="output" prefix="ERROR" lib_name="ERROR" size="1"/>
      <port type="output" prefix="CHANNEL_OUT_OP" lib_name="CHANNEL_OUT_OP" size="68"/>
      <port type="output" prefix="FLOW_CTRL_OUT_IP" lib_name="FLOW_CTRL_OUT_IP" size="2"/>
  ...
  <pb_type_annotations>
    ...
    <pb_type name="router" physical_mode_name="router_slice" idle_mode_name="router_slice"/>
    ...
    <!-- <pb_type name="router[router_slice].router_slice.router_slice" circuit_model_name="router_slice"/>
    <pb_type name="router[router_slice].router_slice.ff_clk" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_reset" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_ROUTER_ADDRESS" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_CHANNEL_IN_IP" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_FLOW_CTRL_IN_OP" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_ERROR" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_CHANNEL_OUT_OP" circuit_model_name="DFFSRQ"/>
    <pb_type name="router[router_slice].router_slice.ff_FLOW_CTRL_OUT_IP" circuit_model_name="DFFSRQ"/> -->
  </pb_type_annotations>
</openfpga_architecture>
