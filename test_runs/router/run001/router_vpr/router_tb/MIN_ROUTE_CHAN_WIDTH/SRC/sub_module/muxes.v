...
// ----- Verilog module for mux_tree_tapbuf_size58 -----
module mux_tree_tapbuf_size58(in,
                              sram,
                              sram_inv,
                              out);
//----- INPUT PORTS -----
...
// ----- END Local output short connections -----
	...
	tap_buf4 tap_buf4_0_ (
		.in(mux_tree_tapbuf_basis_input2_mem1_57_out),
		.out(out));
	...
	mux_tree_tapbuf_basis_input2_mem1 mux_l2_in_13_ (
		.in({mux_tree_tapbuf_basis_input2_mem1_26_out, INVTX1_54_out}),
		.mem(sram[1]),
		.mem_inv(sram_inv[1]),
	...
	mux_tree_tapbuf_basis_input2_mem1 mux_l2_in_15_ (
		.in({INVTX1_57_out, const1_0_const1}),
		.mem(sram[1]),
		.mem_inv(sram_inv[1]),
...
// ----- END Verilog module for mux_tree_tapbuf_size58 -----
...
// ----- Verilog module for mux_tree_tapbuf_size31 -----
module mux_tree_tapbuf_size31(in,
                              sram,
                              sram_inv,
                              out);
//----- INPUT PORTS -----
...
// ----- END Local output short connections -----
	...
	tap_buf4 tap_buf4_0_ (
		.in(mux_tree_tapbuf_basis_input2_mem1_30_out),
		.out(out));
...
// ----- END Verilog module for mux_tree_tapbuf_size31 -----
...
// ----- END Local output short connections -----
	...
	tap_buf4 tap_buf4_0_ (
		.in(mux_tree_tapbuf_basis_input2_mem1_28_out),
		.out(out));
	...
	mux_tree_tapbuf_basis_input2_mem1 mux_l2_in_7_ (
		.in({INVTX1_28_out, const1_0_const1}),
		.mem(sram[1]),
		.mem_inv(sram_inv[1]),
		.out(mux_tree_tapbuf_basis_input2_mem1_21_out));
