...
module router_wrap(
    ...
    input [0:67] channel_in_ip_0,
    input [0:67] channel_in_ip_1,
    input [0:67] channel_in_ip_2,
    input [0:67] channel_in_ip_3,
    input [0:67] channel_in_ip_4,

    // input [0:9] flow_ctrl_in_op, 
    input [0:1] flow_ctrl_in_op_0 ,
    input [0:1] flow_ctrl_in_op_1 ,
    input [0:1] flow_ctrl_in_op_2 ,
    input [0:1] flow_ctrl_in_op_3 ,
    input [0:1] flow_ctrl_in_op_4 ,

    output reg error,
    // output reg [0:339] channel_out_op, 
    output reg [0:67] channel_out_op_0 ,
    output reg [0:67] channel_out_op_1 ,
    output reg [0:67] channel_out_op_2 ,
    output reg [0:67] channel_out_op_3 ,
    output reg [0:67] channel_out_op_4 ,
    // output reg [0:9] flow_ctrl_out_ip 
    output reg [0:1] flow_ctrl_out_ip_0 ,
    output reg [0:1] flow_ctrl_out_ip_1 ,
    output reg [0:1] flow_ctrl_out_ip_2 ,
    output reg [0:1] flow_ctrl_out_ip_3 ,
    output reg [0:1] flow_ctrl_out_ip_4 
);
