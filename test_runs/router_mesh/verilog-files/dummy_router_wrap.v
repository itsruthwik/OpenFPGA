...
module router_wrap(
  ...
  always @(posedge clk or posedge reset) begin
     ...
     channel_out_op_0 <= channel_in_ip_0 ;
     channel_out_op_1 <= channel_in_ip_1 ;
     channel_out_op_2 <= channel_in_ip_2 ;
     channel_out_op_3 <= channel_in_ip_3 ;
     channel_out_op_4 <= channel_in_ip_4 ;
     flow_ctrl_out_ip_0 <= flow_ctrl_in_op_0 ;
     flow_ctrl_out_ip_1 <= flow_ctrl_in_op_1 ;
     flow_ctrl_out_ip_2 <= flow_ctrl_in_op_2 ;
     flow_ctrl_out_ip_3 <= flow_ctrl_in_op_3 ;
     flow_ctrl_out_ip_4 <= flow_ctrl_in_op_4 ;
