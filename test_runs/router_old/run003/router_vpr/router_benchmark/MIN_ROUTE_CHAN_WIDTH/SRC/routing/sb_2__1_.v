...
module sb_2__1_(pReset,
                prog_clk,
                chany_top_in,
                top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_15_,
                top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_55_,
                chanx_right_in,
                ...
                chany_bottom_in,
                bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_14_,
                bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_54_,
                ccff_head,
                chany_top_out,
                chanx_right_out,
                chany_bottom_out,
...
//----- INPUT PORTS -----
input [0:0] top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_15_;
//----- INPUT PORTS -----
input [0:0] top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_55_;
//----- INPUT PORTS -----
...
//----- INPUT PORTS -----
input [0:0] bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_14_;
//----- INPUT PORTS -----
input [0:0] bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_54_;
//----- INPUT PORTS -----
input [0:0] ccff_head;
//----- OUTPUT PORTS -----
...
// ----- END Local output short connections -----
	...
	mux_tree_tapbuf_size5 mux_top_track_0 (
		.in({top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_15_, top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_55_, chanx_right_in[1], chanx_right_in[6], chanx_right_in[11]}),
	...
	mux_tree_tapbuf_size4 mux_top_track_2 (
		.in({top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_15_, top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_55_, chanx_right_in[2], chanx_right_in[7]}),
	...
	mux_tree_tapbuf_size4 mux_bottom_track_1 (
		.in({chanx_right_in[3], chanx_right_in[8], bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_14_, bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_54_}),
		.sram(mux_tree_tapbuf_size4_6_sram[0:2]),
		.sram_inv(mux_bottom_track_1_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[0]));

	mux_tree_tapbuf_size4 mux_bottom_track_3 (
		.in({chanx_right_in[2], chanx_right_in[7], bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_14_, bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_54_}),
		.sram(mux_tree_tapbuf_size4_7_sram[0:2]),
		.sram_inv(mux_bottom_track_3_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[1]));

	mux_tree_tapbuf_size4 mux_bottom_track_5 (
		.in({chanx_right_in[1], chanx_right_in[6], chanx_right_in[11], bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_14_}),
		.sram(mux_tree_tapbuf_size4_8_sram[0:2]),
		.sram_inv(mux_bottom_track_5_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[2]));

	mux_tree_tapbuf_size4 mux_bottom_track_13 (
		.in({chanx_right_in[0], chanx_right_in[5], chanx_right_in[10], bottom_left_grid_right_width_0_height_0_subtile_0__pin_channel_out_op_54_}),
	...
	mux_tree_tapbuf_size3 mux_top_track_4 (
		.in({top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_15_, chanx_right_in[3], chanx_right_in[8]}),
		.sram(mux_tree_tapbuf_size3_0_sram[0:1]),
		.sram_inv(mux_top_track_4_undriven_sram_inv[0:1]),
		.out(chany_top_out[2]));

	mux_tree_tapbuf_size3 mux_top_track_12 (
		.in({top_left_grid_right_width_0_height_1_subtile_0__pin_channel_out_op_55_, chanx_right_in[4], chanx_right_in[9]}),
		.sram(mux_tree_tapbuf_size3_1_sram[0:1]),
		.sram_inv(mux_top_track_12_undriven_sram_inv[0:1]),
		.out(chany_top_out[6]));

	mux_tree_tapbuf_size3 mux_top_track_20 (
		.in({chanx_right_in[0], chanx_right_in[5], chanx_right_in[10]}),
	...
	mux_tree_tapbuf_size2 mux_bottom_track_21 (
		.in({chanx_right_in[4], chanx_right_in[9]}),
