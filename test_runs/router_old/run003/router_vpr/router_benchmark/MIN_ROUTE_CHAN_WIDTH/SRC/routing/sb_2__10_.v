...
module sb_2__10_(pReset,
                 ...
                 chany_bottom_in,
                 bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_23_,
                 bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_63_,
                 chanx_left_in,
                 left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_13_,
                 left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_53_,
                 ccff_head,
                 chany_top_out,
                 chanx_right_out,
                 chany_bottom_out,
...
//----- INPUT PORTS -----
input [0:0] bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_23_;
//----- INPUT PORTS -----
input [0:0] bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_63_;
//----- INPUT PORTS -----
input [0:11] chanx_left_in;
//----- INPUT PORTS -----
input [0:0] left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_13_;
//----- INPUT PORTS -----
input [0:0] left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_53_;
//----- INPUT PORTS -----
input [0:0] ccff_head;
//----- OUTPUT PORTS -----
...
// ----- END Local output short connections -----
	...
	mux_tree_tapbuf_size8 mux_bottom_track_1 (
		.in({chanx_right_in[2], chanx_right_in[8:9], bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_23_, bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_63_, chanx_left_in[1:2], chanx_left_in[8]}),
		.sram(mux_tree_tapbuf_size8_0_sram[0:3]),
		.sram_inv(mux_bottom_track_1_undriven_sram_inv[0:3]),
		.out(chany_bottom_out[0]));

	mux_tree_tapbuf_size8 mux_bottom_track_3 (
		.in({chanx_right_in[3], chanx_right_in[5], chanx_right_in[10], bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_23_, bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_63_, chanx_left_in[3], chanx_left_in[5], chanx_left_in[10]}),
		.sram(mux_tree_tapbuf_size8_1_sram[0:3]),
		.sram_inv(mux_bottom_track_3_undriven_sram_inv[0:3]),
		.out(chany_bottom_out[1]));

	mux_tree_tapbuf_size8 mux_left_track_1 (
		.in({chany_top_in[0], chany_top_in[2], chany_top_in[8], chany_bottom_in[2], chany_bottom_in[8], chany_bottom_in[11], left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_13_, left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_53_}),
		.sram(mux_tree_tapbuf_size8_2_sram[0:3]),
		.sram_inv(mux_left_track_1_undriven_sram_inv[0:3]),
		.out(chanx_left_out[0]));

	mux_tree_tapbuf_size8 mux_left_track_3 (
		.in({chany_top_in[3], chany_top_in[10:11], chany_bottom_in[0], chany_bottom_in[3], chany_bottom_in[10], left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_13_, left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_53_}),
	...
	mux_tree_tapbuf_size5 mux_bottom_track_5 (
		.in({chanx_right_in[1], chanx_right_in[4], bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_23_, chanx_left_in[4], chanx_left_in[9]}),
		.sram(mux_tree_tapbuf_size5_0_sram[0:2]),
		.sram_inv(mux_bottom_track_5_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[2]));

	mux_tree_tapbuf_size5 mux_bottom_track_13 (
		.in({chanx_right_in[0], chanx_right_in[6], bottom_left_grid_right_width_0_height_9_subtile_0__pin_channel_out_op_63_, chanx_left_in[6], chanx_left_in[11]}),
		.sram(mux_tree_tapbuf_size5_1_sram[0:2]),
		.sram_inv(mux_bottom_track_13_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[6]));

	mux_tree_tapbuf_size5 mux_left_track_5 (
		.in({chany_top_in[4], chany_top_in[9], chany_bottom_in[1], chany_bottom_in[4], left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_13_}),
		.sram(mux_tree_tapbuf_size5_2_sram[0:2]),
		.sram_inv(mux_left_track_5_undriven_sram_inv[0:2]),
		.out(chanx_left_out[2]));

	mux_tree_tapbuf_size5 mux_left_track_13 (
		.in({chany_top_in[5:6], chany_bottom_in[5:6], left_bottom_grid_top_width_0_height_9_subtile_0__pin_channel_out_op_53_}),
	...
	mux_tree_tapbuf_size4 mux_bottom_track_21 (
		.in({chanx_right_in[7], chanx_right_in[11], chanx_left_in[0], chanx_left_in[7]}),
		.sram(mux_tree_tapbuf_size4_0_sram[0:2]),
		.sram_inv(mux_bottom_track_21_undriven_sram_inv[0:2]),
		.out(chany_bottom_out[10]));

	mux_tree_tapbuf_size4 mux_left_track_21 (
		.in({chany_top_in[1], chany_top_in[7], chany_bottom_in[7], chany_bottom_in[9]}),
