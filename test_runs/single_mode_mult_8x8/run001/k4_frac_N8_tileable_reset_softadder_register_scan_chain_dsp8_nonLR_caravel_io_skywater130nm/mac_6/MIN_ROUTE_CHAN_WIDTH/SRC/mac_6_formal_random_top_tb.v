...
//	Description: FPGA Verilog Testbench for Formal Top-level netlist of Design: mac_6
//	Author: Xifan TANG
...
module mac_6_top_formal_verification_random_tb;
...
// ----- FPGA fabric instanciation -------
	mac_6_top_formal_verification FPGA_DUT(
		a_0_,
		a_1_,
		a_2_,
		a_3_,
...
// ----- Begin output waveform to VCD file-------
	initial begin
		$dumpfile("mac_6_formal.vcd");
		$dumpvars(1, mac_6_top_formal_verification_random_tb);
	end
...
// ----- END Verilog module for mac_6_top_formal_verification_random_tb -----
