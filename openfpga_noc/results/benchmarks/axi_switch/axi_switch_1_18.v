...
module axis_switch_1_to_18 (
    ...
    // axis_in_14  input AXI Stream interface  
    input     [127:0]   axis_in_14_tdata,
    input               axis_in_14_tvalid,
    input     [3:0]     axis_in_14_tdest,
    input     [1:0]     axis_in_14_tid,
    output reg          axis_in_14_tready,
    // axis_out_14  output AXI Stream interface  
    output reg [127:0]  axis_out_14_tdata,
    output reg          axis_out_14_tvalid,
    output reg [3:0]    axis_out_14_tdest,
    output reg [1:0]    axis_out_14_tid,
    input               axis_out_14_tready,

    // axis_in_15  input AXI Stream interface  
    input     [127:0]   axis_in_15_tdata,
    input               axis_in_15_tvalid,
    input     [3:0]     axis_in_15_tdest,
    input     [1:0]     axis_in_15_tid,
    output reg          axis_in_15_tready,
    // axis_out_15  output AXI Stream interface  
    output reg [127:0]  axis_out_15_tdata,
    output reg          axis_out_15_tvalid,
    output reg [3:0]    axis_out_15_tdest,
    output reg [1:0]    axis_out_15_tid,
    input               axis_out_15_tready,

    // axis_in_16  input AXI Stream interface  
    input     [127:0]   axis_in_16_tdata,
    input               axis_in_16_tvalid,
    input     [3:0]     axis_in_16_tdest,
    input     [1:0]     axis_in_16_tid,
    output reg          axis_in_16_tready,
    // axis_out_16  output AXI Stream interface  
    output reg [127:0]  axis_out_16_tdata,
    output reg          axis_out_16_tvalid,
    output reg [3:0]    axis_out_16_tdest,
    output reg [1:0]    axis_out_16_tid,
    input               axis_out_16_tready,

    // axis_in_17  input AXI Stream interface  
    input     [127:0]   axis_in_17_tdata,
    input               axis_in_17_tvalid,
    input     [3:0]     axis_in_17_tdest,
    input     [1:0]     axis_in_17_tid,
    output reg          axis_in_17_tready,
    // axis_out_17  output AXI Stream interface  
    output reg [127:0]  axis_out_17_tdata,
    output reg          axis_out_17_tvalid,
    output reg [3:0]    axis_out_17_tdest,
    output reg [1:0]    axis_out_17_tid,
    input               axis_out_17_tready,

    // axis_in_18  input AXI Stream interface  
    input     [127:0]   axis_in_18_tdata,
    input               axis_in_18_tvalid,
    input     [3:0]     axis_in_18_tdest,
    input     [1:0]     axis_in_18_tid,
    output reg          axis_in_18_tready,
    // axis_out_18  output AXI Stream interface  
    output reg [127:0]  axis_out_18_tdata,
    output reg          axis_out_18_tvalid,
    output reg [3:0]    axis_out_18_tdest,
    output reg [1:0]    axis_out_18_tid,
    input               axis_out_18_tready
...
case (axis_in_0_tdest)
    4'd1: begin
        ...
        axis_out_14_tdata <= {128{1'b0}};
        axis_out_14_tvalid <= 1'b0;
        axis_out_14_tdest <= {4{1'b0}};
        axis_out_14_tid <= {2{1'b0}};
        axis_out_15_tdata <= {128{1'b0}};
        axis_out_15_tvalid <= 1'b0;
        axis_out_15_tdest <= {4{1'b0}};
        axis_out_15_tid <= {2{1'b0}};
        axis_out_16_tdata <= {128{1'b0}};
        axis_out_16_tvalid <= 1'b0;
        axis_out_16_tdest <= {4{1'b0}};
        axis_out_16_tid <= {2{1'b0}};
        axis_out_17_tdata <= {128{1'b0}};
        axis_out_17_tvalid <= 1'b0;
        axis_out_17_tdest <= {4{1'b0}};
        axis_out_17_tid <= {2{1'b0}};
        axis_out_18_tdata <= {128{1'b0}};
        axis_out_18_tvalid <= 1'b0;
        axis_out_18_tdest <= {4{1'b0}};
        axis_out_18_tid <= {2{1'b0}};
    end
    4'd2: begin
    ...
    4'd14: begin
        ...
        axis_out_13_tid <= {2{1'b0}};
        // Connect axis_in_0 to axis_out_{i+1}
        axis_out_14_tdata <= axis_in_0_tdata;
        axis_out_14_tvalid <= axis_in_0_tvalid;
        axis_out_14_tdest <= axis_in_0_tdest;
        axis_out_14_tid <= axis_in_0_tid;
        axis_in_0_tready <= axis_out_14_tready;
        // all other outputs to zero
        axis_out_15_tdata <= {128{1'b0}};
        axis_out_15_tvalid <= 1'b0;
        axis_out_15_tdest <= {4{1'b0}};
    ...
    4'd15: begin
        ...
        axis_out_14_tid <= {2{1'b0}};
        // Connect axis_in_0 to axis_out_{i+1}
        axis_out_15_tdata <= axis_in_0_tdata;
        axis_out_15_tvalid <= axis_in_0_tvalid;
        axis_out_15_tdest <= axis_in_0_tdest;
        axis_out_15_tid <= axis_in_0_tid;
        axis_in_0_tready <= axis_out_15_tready;
        // all other outputs to zero
        axis_out_16_tdata <= {128{1'b0}};
        axis_out_16_tvalid <= 1'b0;
        axis_out_16_tdest <= {4{1'b0}};
    ...
    4'd16: begin
        ...
        axis_out_15_tid <= {2{1'b0}};
        // Connect axis_in_0 to axis_out_{i+1}
        axis_out_16_tdata <= axis_in_0_tdata;
        axis_out_16_tvalid <= axis_in_0_tvalid;
        axis_out_16_tdest <= axis_in_0_tdest;
        axis_out_16_tid <= axis_in_0_tid;
        axis_in_0_tready <= axis_out_16_tready;
        // all other outputs to zero
        axis_out_17_tdata <= {128{1'b0}};
        axis_out_17_tvalid <= 1'b0;
        axis_out_17_tdest <= {4{1'b0}};
    ...
    4'd17: begin
        ...
        axis_out_16_tid <= {2{1'b0}};
        // Connect axis_in_0 to axis_out_{i+1}
        axis_out_17_tdata <= axis_in_0_tdata;
        axis_out_17_tvalid <= axis_in_0_tvalid;
        axis_out_17_tdest <= axis_in_0_tdest;
        axis_out_17_tid <= axis_in_0_tid;
        axis_in_0_tready <= axis_out_17_tready;
        // all other outputs to zero
        axis_out_18_tdata <= {128{1'b0}};
        axis_out_18_tvalid <= 1'b0;
        axis_out_18_tdest <= {4{1'b0}};
    ...
    4'd18: begin
        ...
        axis_out_17_tid <= {2{1'b0}};
        // Connect axis_in_0 to axis_out_{i+1}
        axis_out_18_tdata <= axis_in_0_tdata;
        axis_out_18_tvalid <= axis_in_0_tvalid;
        axis_out_18_tdest <= axis_in_0_tdest;
        axis_out_18_tid <= axis_in_0_tid;
        axis_in_0_tready <= axis_out_18_tready;
        // all other outputs to zero
    end
    default: begin
        // Default case: connect to zero
        axis_out_1_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_1_tdata;
        axis_out_1_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_1_tvalid;
        axis_out_1_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_1_tdest;
        axis_out_1_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_1_tid;

        axis_out_2_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_2_tdata;
        axis_out_2_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_2_tvalid;
        axis_out_2_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_2_tdest;
        axis_out_2_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_2_tid;

        axis_out_3_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_3_tdata;
        axis_out_3_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_3_tvalid;
        axis_out_3_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_3_tdest;
        axis_out_3_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_3_tid;

        axis_out_4_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_4_tdata;
        axis_out_4_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_4_tvalid;
        axis_out_4_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_4_tdest;
        axis_out_4_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_4_tid;

        axis_out_5_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_5_tdata;
        axis_out_5_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_5_tvalid;
        axis_out_5_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_5_tdest;
        axis_out_5_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_5_tid;

        axis_out_6_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_6_tdata;
        axis_out_6_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_6_tvalid;
        axis_out_6_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_6_tdest;
        axis_out_6_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_6_tid;

        axis_out_7_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_7_tdata;
        axis_out_7_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_7_tvalid;
        axis_out_7_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_7_tdest;
        axis_out_7_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_7_tid;

        axis_out_8_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_8_tdata;
        axis_out_8_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_8_tvalid;
        axis_out_8_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_8_tdest;
        axis_out_8_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_8_tid;

        axis_out_9_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_9_tdata;
        axis_out_9_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_9_tvalid;
        axis_out_9_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_9_tdest;
        axis_out_9_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_9_tid;

        axis_out_10_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_10_tdata;
        axis_out_10_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_10_tvalid;
        axis_out_10_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_10_tdest;
        axis_out_10_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_10_tid;

        axis_out_11_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_11_tdata;
        axis_out_11_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_11_tvalid;
        axis_out_11_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_11_tdest;
        axis_out_11_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_11_tid;

        axis_out_12_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_12_tdata;
        axis_out_12_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_12_tvalid;
        axis_out_12_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_12_tdest;
        axis_out_12_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_12_tid;

        axis_out_13_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_13_tdata;
        axis_out_13_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_13_tvalid;
        axis_out_13_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_13_tdest;
        axis_out_13_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_13_tid;

        axis_out_14_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_14_tdata;
        axis_out_14_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_14_tvalid;
        axis_out_14_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_14_tdest;
        axis_out_14_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_14_tid;

        axis_out_15_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_15_tdata;
        axis_out_15_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_15_tvalid;
        axis_out_15_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_15_tdest;
        axis_out_15_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_15_tid;

        axis_out_16_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_16_tdata;
        axis_out_16_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_16_tvalid;
        axis_out_16_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_16_tdest;
        axis_out_16_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_16_tid;

        axis_out_17_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_17_tdata;
        axis_out_17_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_17_tvalid;
        axis_out_17_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_17_tdest;
        axis_out_17_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_17_tid;

        axis_out_18_tdata <= axis_in_17_tdata ;   //axis_in_0_tdata ^ axis_in_18_tdata;
        axis_out_18_tvalid <= axis_in_17_tvalid ;   //axis_in_0_tvalid ^ axis_in_18_tvalid;
        axis_out_18_tdest <= axis_in_17_tdest ;   //axis_in_0_tdest ^ axis_in_18_tdest;
        axis_out_18_tid <= axis_in_17_tid ;   //axis_in_0_tid ^ axis_in_18_tid;
...
always @(*) begin
    ...
    else if (axis_in_14_tvalid && (axis_in_14_tdest == 4'b0000)) begin
        // Connect axis_in_14 to axis_out_0
        axis_out_0_tdata <= axis_in_14_tdata;
        axis_out_0_tvalid <= axis_in_14_tvalid;
        axis_out_0_tdest <= axis_in_14_tdest;
        axis_out_0_tid <= axis_in_14_tid;
        axis_in_14_tready <= axis_out_0_tready;
    end 
    else if (axis_in_15_tvalid && (axis_in_15_tdest == 4'b0000)) begin
        // Connect axis_in_15 to axis_out_0
        axis_out_0_tdata <= axis_in_15_tdata;
        axis_out_0_tvalid <= axis_in_15_tvalid;
        axis_out_0_tdest <= axis_in_15_tdest;
        axis_out_0_tid <= axis_in_15_tid;
        axis_in_15_tready <= axis_out_0_tready;
    end 
    else if (axis_in_16_tvalid && (axis_in_16_tdest == 4'b0000)) begin
        // Connect axis_in_16 to axis_out_0
        axis_out_0_tdata <= axis_in_16_tdata;
        axis_out_0_tvalid <= axis_in_16_tvalid;
        axis_out_0_tdest <= axis_in_16_tdest;
        axis_out_0_tid <= axis_in_16_tid;
        axis_in_16_tready <= axis_out_0_tready;
    end 
    else if (axis_in_17_tvalid && (axis_in_17_tdest == 4'b0000)) begin
        // Connect axis_in_17 to axis_out_0
        axis_out_0_tdata <= axis_in_17_tdata;
        axis_out_0_tvalid <= axis_in_17_tvalid;
        axis_out_0_tdest <= axis_in_17_tdest;
        axis_out_0_tid <= axis_in_17_tid;
        axis_in_17_tready <= axis_out_0_tready;
    end 
    else if (axis_in_18_tvalid && (axis_in_18_tdest == 4'b0000)) begin
        // Connect axis_in_18 to axis_out_0
        axis_out_0_tdata <= axis_in_18_tdata;
        axis_out_0_tvalid <= axis_in_18_tvalid;
        axis_out_0_tdest <= axis_in_18_tdest;
        axis_out_0_tid <= axis_in_18_tid;
        axis_in_18_tready <= axis_out_0_tready;
    end 
    else begin
            // Default values
        axis_in_1_tready = axis_out_0_tready;
