...
case (axis_in_0_tdest)
    ...
    default: begin
        ...
        axis_out_1_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_1_tdata;
        axis_out_1_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_1_tvalid;
        axis_out_1_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_1_tdest;
        axis_out_1_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_1_tid;

        axis_out_2_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_2_tdata;
        axis_out_2_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_2_tvalid;
        axis_out_2_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_2_tdest;
        axis_out_2_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_2_tid;

        axis_out_3_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_3_tdata;
        axis_out_3_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_3_tvalid;
        axis_out_3_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_3_tdest;
        axis_out_3_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_3_tid;

        axis_out_4_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_4_tdata;
        axis_out_4_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_4_tvalid;
        axis_out_4_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_4_tdest;
        axis_out_4_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_4_tid;

        axis_out_5_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_5_tdata;
        axis_out_5_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_5_tvalid;
        axis_out_5_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_5_tdest;
        axis_out_5_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_5_tid;

        axis_out_6_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_6_tdata;
        axis_out_6_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_6_tvalid;
        axis_out_6_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_6_tdest;
        axis_out_6_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_6_tid;

        axis_out_7_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_7_tdata;
        axis_out_7_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_7_tvalid;
        axis_out_7_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_7_tdest;
        axis_out_7_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_7_tid;

        axis_out_8_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_8_tdata;
        axis_out_8_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_8_tvalid;
        axis_out_8_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_8_tdest;
        axis_out_8_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_8_tid;

        axis_out_9_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_9_tdata;
        axis_out_9_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_9_tvalid;
        axis_out_9_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_9_tdest;
        axis_out_9_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_9_tid;

        axis_out_10_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_10_tdata;
        axis_out_10_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_10_tvalid;
        axis_out_10_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_10_tdest;
        axis_out_10_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_10_tid;

        axis_out_11_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_11_tdata;
        axis_out_11_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_11_tvalid;
        axis_out_11_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_11_tdest;
        axis_out_11_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_11_tid;

        axis_out_12_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_12_tdata;
        axis_out_12_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_12_tvalid;
        axis_out_12_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_12_tdest;
        axis_out_12_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_12_tid;

        axis_out_13_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_13_tdata;
        axis_out_13_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_13_tvalid;
        axis_out_13_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_13_tdest;
        axis_out_13_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_13_tid;

        axis_out_14_tdata <= axis_in_13_tdata ;   //axis_in_0_tdata ^ axis_in_14_tdata;
        axis_out_14_tvalid <= axis_in_13_tvalid ;   //axis_in_0_tvalid ^ axis_in_14_tvalid;
        axis_out_14_tdest <= axis_in_13_tdest ;   //axis_in_0_tdest ^ axis_in_14_tdest;
        axis_out_14_tid <= axis_in_13_tid ;   //axis_in_0_tid ^ axis_in_14_tid;
