...
always @(*) begin
    ...
    if (axis_in_0_tvalid && axis_in_0_tdest < 13) begin
        case (axis_in_0_tdest)
                ...
                9: axis_in_0_tready = axis_out_9_tready;
                10: axis_in_0_tready = axis_out_10_tready;
                11: axis_in_0_tready = axis_out_11_tready;
                12: axis_in_0_tready = axis_out_12_tready;
            default: axis_in_0_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_1_tready = 1'b0; // Default to not ready
    if (axis_in_1_tvalid && axis_in_1_tdest < 13) begin
        case (axis_in_1_tdest)
                ...
                9: axis_in_1_tready = axis_out_9_tready;
                10: axis_in_1_tready = axis_out_10_tready;
                11: axis_in_1_tready = axis_out_11_tready;
                12: axis_in_1_tready = axis_out_12_tready;
            default: axis_in_1_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_2_tready = 1'b0; // Default to not ready
    if (axis_in_2_tvalid && axis_in_2_tdest < 13) begin
        case (axis_in_2_tdest)
                ...
                9: axis_in_2_tready = axis_out_9_tready;
                10: axis_in_2_tready = axis_out_10_tready;
                11: axis_in_2_tready = axis_out_11_tready;
                12: axis_in_2_tready = axis_out_12_tready;
            default: axis_in_2_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_3_tready = 1'b0; // Default to not ready
    if (axis_in_3_tvalid && axis_in_3_tdest < 13) begin
        case (axis_in_3_tdest)
                ...
                9: axis_in_3_tready = axis_out_9_tready;
                10: axis_in_3_tready = axis_out_10_tready;
                11: axis_in_3_tready = axis_out_11_tready;
                12: axis_in_3_tready = axis_out_12_tready;
            default: axis_in_3_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_4_tready = 1'b0; // Default to not ready
    if (axis_in_4_tvalid && axis_in_4_tdest < 13) begin
        case (axis_in_4_tdest)
                ...
                9: axis_in_4_tready = axis_out_9_tready;
                10: axis_in_4_tready = axis_out_10_tready;
                11: axis_in_4_tready = axis_out_11_tready;
                12: axis_in_4_tready = axis_out_12_tready;
            default: axis_in_4_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_5_tready = 1'b0; // Default to not ready
    if (axis_in_5_tvalid && axis_in_5_tdest < 13) begin
        case (axis_in_5_tdest)
                ...
                9: axis_in_5_tready = axis_out_9_tready;
                10: axis_in_5_tready = axis_out_10_tready;
                11: axis_in_5_tready = axis_out_11_tready;
                12: axis_in_5_tready = axis_out_12_tready;
            default: axis_in_5_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_6_tready = 1'b0; // Default to not ready
    if (axis_in_6_tvalid && axis_in_6_tdest < 13) begin
        case (axis_in_6_tdest)
                ...
                9: axis_in_6_tready = axis_out_9_tready;
                10: axis_in_6_tready = axis_out_10_tready;
                11: axis_in_6_tready = axis_out_11_tready;
                12: axis_in_6_tready = axis_out_12_tready;
            default: axis_in_6_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_7_tready = 1'b0; // Default to not ready
    if (axis_in_7_tvalid && axis_in_7_tdest < 13) begin
        case (axis_in_7_tdest)
                ...
                9: axis_in_7_tready = axis_out_9_tready;
                10: axis_in_7_tready = axis_out_10_tready;
                11: axis_in_7_tready = axis_out_11_tready;
                12: axis_in_7_tready = axis_out_12_tready;
            default: axis_in_7_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_8_tready = 1'b0; // Default to not ready
    if (axis_in_8_tvalid && axis_in_8_tdest < 13) begin
        case (axis_in_8_tdest)
                ...
                9: axis_in_8_tready = axis_out_9_tready;
                10: axis_in_8_tready = axis_out_10_tready;
                11: axis_in_8_tready = axis_out_11_tready;
                12: axis_in_8_tready = axis_out_12_tready;
            default: axis_in_8_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_9_tready = 1'b0; // Default to not ready
    if (axis_in_9_tvalid && axis_in_9_tdest < 13) begin
        case (axis_in_9_tdest)
                0: axis_in_9_tready = axis_out_0_tready;
                1: axis_in_9_tready = axis_out_1_tready;
                2: axis_in_9_tready = axis_out_2_tready;
                3: axis_in_9_tready = axis_out_3_tready;
                4: axis_in_9_tready = axis_out_4_tready;
                5: axis_in_9_tready = axis_out_5_tready;
                6: axis_in_9_tready = axis_out_6_tready;
                7: axis_in_9_tready = axis_out_7_tready;
                8: axis_in_9_tready = axis_out_8_tready;
                9: axis_in_9_tready = axis_out_9_tready;
                10: axis_in_9_tready = axis_out_10_tready;
                11: axis_in_9_tready = axis_out_11_tready;
                12: axis_in_9_tready = axis_out_12_tready;
            default: axis_in_9_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_10_tready = 1'b0; // Default to not ready
    if (axis_in_10_tvalid && axis_in_10_tdest < 13) begin
        case (axis_in_10_tdest)
                0: axis_in_10_tready = axis_out_0_tready;
                1: axis_in_10_tready = axis_out_1_tready;
                2: axis_in_10_tready = axis_out_2_tready;
                3: axis_in_10_tready = axis_out_3_tready;
                4: axis_in_10_tready = axis_out_4_tready;
                5: axis_in_10_tready = axis_out_5_tready;
                6: axis_in_10_tready = axis_out_6_tready;
                7: axis_in_10_tready = axis_out_7_tready;
                8: axis_in_10_tready = axis_out_8_tready;
                9: axis_in_10_tready = axis_out_9_tready;
                10: axis_in_10_tready = axis_out_10_tready;
                11: axis_in_10_tready = axis_out_11_tready;
                12: axis_in_10_tready = axis_out_12_tready;
            default: axis_in_10_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_11_tready = 1'b0; // Default to not ready
    if (axis_in_11_tvalid && axis_in_11_tdest < 13) begin
        case (axis_in_11_tdest)
                0: axis_in_11_tready = axis_out_0_tready;
                1: axis_in_11_tready = axis_out_1_tready;
                2: axis_in_11_tready = axis_out_2_tready;
                3: axis_in_11_tready = axis_out_3_tready;
                4: axis_in_11_tready = axis_out_4_tready;
                5: axis_in_11_tready = axis_out_5_tready;
                6: axis_in_11_tready = axis_out_6_tready;
                7: axis_in_11_tready = axis_out_7_tready;
                8: axis_in_11_tready = axis_out_8_tready;
                9: axis_in_11_tready = axis_out_9_tready;
                10: axis_in_11_tready = axis_out_10_tready;
                11: axis_in_11_tready = axis_out_11_tready;
                12: axis_in_11_tready = axis_out_12_tready;
            default: axis_in_11_tready = 1'b0; // No valid output port
        endcase        
    end
    axis_in_12_tready = 1'b0; // Default to not ready
    if (axis_in_12_tvalid && axis_in_12_tdest < 13) begin
        case (axis_in_12_tdest)
                0: axis_in_12_tready = axis_out_0_tready;
                1: axis_in_12_tready = axis_out_1_tready;
                2: axis_in_12_tready = axis_out_2_tready;
                3: axis_in_12_tready = axis_out_3_tready;
                4: axis_in_12_tready = axis_out_4_tready;
                5: axis_in_12_tready = axis_out_5_tready;
                6: axis_in_12_tready = axis_out_6_tready;
                7: axis_in_12_tready = axis_out_7_tready;
                8: axis_in_12_tready = axis_out_8_tready;
                9: axis_in_12_tready = axis_out_9_tready;
                10: axis_in_12_tready = axis_out_10_tready;
                11: axis_in_12_tready = axis_out_11_tready;
                12: axis_in_12_tready = axis_out_12_tready;
            default: axis_in_12_tready = 1'b0; // No valid output port
        endcase        
    end
end
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 0) begin
        // Connect input port 9 to output port 0
    ...
    if (axis_in_10_tdest == 0) begin
        // Connect input port 10 to output port 0
    ...
    if (axis_in_11_tdest == 0) begin
        // Connect input port 11 to output port 0
    ...
    if (axis_in_12_tdest == 0) begin
        // Connect input port 12 to output port 0
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 1) begin
        // Connect input port 9 to output port 1
        axis_out_1_tdata = axis_in_9_tdata;
        axis_out_1_tvalid = axis_in_9_tvalid;
        axis_out_1_tdest = axis_in_9_tdest;
        axis_out_1_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 1) begin
        // Connect input port 10 to output port 1
        axis_out_1_tdata = axis_in_10_tdata;
        axis_out_1_tvalid = axis_in_10_tvalid;
        axis_out_1_tdest = axis_in_10_tdest;
        axis_out_1_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 1) begin
        // Connect input port 11 to output port 1
        axis_out_1_tdata = axis_in_11_tdata;
        axis_out_1_tvalid = axis_in_11_tvalid;
        axis_out_1_tdest = axis_in_11_tdest;
        axis_out_1_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 1) begin
        // Connect input port 12 to output port 1
        axis_out_1_tdata = axis_in_12_tdata;
        axis_out_1_tvalid = axis_in_12_tvalid;
        axis_out_1_tdest = axis_in_12_tdest;
        axis_out_1_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 2) begin
        // Connect input port 9 to output port 2
        axis_out_2_tdata = axis_in_9_tdata;
        axis_out_2_tvalid = axis_in_9_tvalid;
        axis_out_2_tdest = axis_in_9_tdest;
        axis_out_2_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 2) begin
        // Connect input port 10 to output port 2
        axis_out_2_tdata = axis_in_10_tdata;
        axis_out_2_tvalid = axis_in_10_tvalid;
        axis_out_2_tdest = axis_in_10_tdest;
        axis_out_2_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 2) begin
        // Connect input port 11 to output port 2
        axis_out_2_tdata = axis_in_11_tdata;
        axis_out_2_tvalid = axis_in_11_tvalid;
        axis_out_2_tdest = axis_in_11_tdest;
        axis_out_2_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 2) begin
        // Connect input port 12 to output port 2
        axis_out_2_tdata = axis_in_12_tdata;
        axis_out_2_tvalid = axis_in_12_tvalid;
        axis_out_2_tdest = axis_in_12_tdest;
        axis_out_2_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 3) begin
        // Connect input port 9 to output port 3
        axis_out_3_tdata = axis_in_9_tdata;
        axis_out_3_tvalid = axis_in_9_tvalid;
        axis_out_3_tdest = axis_in_9_tdest;
        axis_out_3_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 3) begin
        // Connect input port 10 to output port 3
        axis_out_3_tdata = axis_in_10_tdata;
        axis_out_3_tvalid = axis_in_10_tvalid;
        axis_out_3_tdest = axis_in_10_tdest;
        axis_out_3_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 3) begin
        // Connect input port 11 to output port 3
        axis_out_3_tdata = axis_in_11_tdata;
        axis_out_3_tvalid = axis_in_11_tvalid;
        axis_out_3_tdest = axis_in_11_tdest;
        axis_out_3_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 3) begin
        // Connect input port 12 to output port 3
        axis_out_3_tdata = axis_in_12_tdata;
        axis_out_3_tvalid = axis_in_12_tvalid;
        axis_out_3_tdest = axis_in_12_tdest;
        axis_out_3_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 4) begin
        // Connect input port 9 to output port 4
        axis_out_4_tdata = axis_in_9_tdata;
        axis_out_4_tvalid = axis_in_9_tvalid;
        axis_out_4_tdest = axis_in_9_tdest;
        axis_out_4_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 4) begin
        // Connect input port 10 to output port 4
        axis_out_4_tdata = axis_in_10_tdata;
        axis_out_4_tvalid = axis_in_10_tvalid;
        axis_out_4_tdest = axis_in_10_tdest;
        axis_out_4_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 4) begin
        // Connect input port 11 to output port 4
        axis_out_4_tdata = axis_in_11_tdata;
        axis_out_4_tvalid = axis_in_11_tvalid;
        axis_out_4_tdest = axis_in_11_tdest;
        axis_out_4_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 4) begin
        // Connect input port 12 to output port 4
        axis_out_4_tdata = axis_in_12_tdata;
        axis_out_4_tvalid = axis_in_12_tvalid;
        axis_out_4_tdest = axis_in_12_tdest;
        axis_out_4_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 5) begin
        // Connect input port 9 to output port 5
        axis_out_5_tdata = axis_in_9_tdata;
        axis_out_5_tvalid = axis_in_9_tvalid;
        axis_out_5_tdest = axis_in_9_tdest;
        axis_out_5_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 5) begin
        // Connect input port 10 to output port 5
        axis_out_5_tdata = axis_in_10_tdata;
        axis_out_5_tvalid = axis_in_10_tvalid;
        axis_out_5_tdest = axis_in_10_tdest;
        axis_out_5_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 5) begin
        // Connect input port 11 to output port 5
        axis_out_5_tdata = axis_in_11_tdata;
        axis_out_5_tvalid = axis_in_11_tvalid;
        axis_out_5_tdest = axis_in_11_tdest;
        axis_out_5_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 5) begin
        // Connect input port 12 to output port 5
        axis_out_5_tdata = axis_in_12_tdata;
        axis_out_5_tvalid = axis_in_12_tvalid;
        axis_out_5_tdest = axis_in_12_tdest;
        axis_out_5_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 6) begin
        // Connect input port 9 to output port 6
        axis_out_6_tdata = axis_in_9_tdata;
        axis_out_6_tvalid = axis_in_9_tvalid;
        axis_out_6_tdest = axis_in_9_tdest;
        axis_out_6_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 6) begin
        // Connect input port 10 to output port 6
        axis_out_6_tdata = axis_in_10_tdata;
        axis_out_6_tvalid = axis_in_10_tvalid;
        axis_out_6_tdest = axis_in_10_tdest;
        axis_out_6_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 6) begin
        // Connect input port 11 to output port 6
        axis_out_6_tdata = axis_in_11_tdata;
        axis_out_6_tvalid = axis_in_11_tvalid;
        axis_out_6_tdest = axis_in_11_tdest;
        axis_out_6_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 6) begin
        // Connect input port 12 to output port 6
        axis_out_6_tdata = axis_in_12_tdata;
        axis_out_6_tvalid = axis_in_12_tvalid;
        axis_out_6_tdest = axis_in_12_tdest;
        axis_out_6_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 7) begin
        // Connect input port 9 to output port 7
        axis_out_7_tdata = axis_in_9_tdata;
        axis_out_7_tvalid = axis_in_9_tvalid;
        axis_out_7_tdest = axis_in_9_tdest;
        axis_out_7_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 7) begin
        // Connect input port 10 to output port 7
        axis_out_7_tdata = axis_in_10_tdata;
        axis_out_7_tvalid = axis_in_10_tvalid;
        axis_out_7_tdest = axis_in_10_tdest;
        axis_out_7_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 7) begin
        // Connect input port 11 to output port 7
        axis_out_7_tdata = axis_in_11_tdata;
        axis_out_7_tvalid = axis_in_11_tvalid;
        axis_out_7_tdest = axis_in_11_tdest;
        axis_out_7_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 7) begin
        // Connect input port 12 to output port 7
        axis_out_7_tdata = axis_in_12_tdata;
        axis_out_7_tvalid = axis_in_12_tvalid;
        axis_out_7_tdest = axis_in_12_tdest;
        axis_out_7_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
always @(*) begin    
    ...
    if (axis_in_9_tdest == 8) begin
        // Connect input port 9 to output port 8
        axis_out_8_tdata = axis_in_9_tdata;
        axis_out_8_tvalid = axis_in_9_tvalid;
        axis_out_8_tdest = axis_in_9_tdest;
        axis_out_8_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 8) begin
        // Connect input port 10 to output port 8
        axis_out_8_tdata = axis_in_10_tdata;
        axis_out_8_tvalid = axis_in_10_tvalid;
        axis_out_8_tdest = axis_in_10_tdest;
        axis_out_8_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 8) begin
        // Connect input port 11 to output port 8
        axis_out_8_tdata = axis_in_11_tdata;
        axis_out_8_tvalid = axis_in_11_tvalid;
        axis_out_8_tdest = axis_in_11_tdest;
        axis_out_8_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 8) begin
        // Connect input port 12 to output port 8
        axis_out_8_tdata = axis_in_12_tdata;
        axis_out_8_tvalid = axis_in_12_tvalid;
        axis_out_8_tdest = axis_in_12_tdest;
        axis_out_8_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
// Output 9 handling
always @(*) begin    
    if (axis_in_0_tdest == 9) begin
        // Connect input port 0 to output port 9
    ...
    if (axis_in_1_tdest == 9) begin
        // Connect input port 1 to output port 9
        axis_out_9_tdata = axis_in_1_tdata;
        axis_out_9_tvalid = axis_in_1_tvalid;
        axis_out_9_tdest = axis_in_1_tdest;
        axis_out_9_tid = axis_in_1_tid;
    end else
    if (axis_in_2_tdest == 9) begin
        // Connect input port 2 to output port 9
        axis_out_9_tdata = axis_in_2_tdata;
        axis_out_9_tvalid = axis_in_2_tvalid;
        axis_out_9_tdest = axis_in_2_tdest;
        axis_out_9_tid = axis_in_2_tid;
    end else
    if (axis_in_3_tdest == 9) begin
        // Connect input port 3 to output port 9
        axis_out_9_tdata = axis_in_3_tdata;
        axis_out_9_tvalid = axis_in_3_tvalid;
        axis_out_9_tdest = axis_in_3_tdest;
        axis_out_9_tid = axis_in_3_tid;
    end else
    if (axis_in_4_tdest == 9) begin
        // Connect input port 4 to output port 9
        axis_out_9_tdata = axis_in_4_tdata;
        axis_out_9_tvalid = axis_in_4_tvalid;
        axis_out_9_tdest = axis_in_4_tdest;
        axis_out_9_tid = axis_in_4_tid;
    end else
    if (axis_in_5_tdest == 9) begin
        // Connect input port 5 to output port 9
        axis_out_9_tdata = axis_in_5_tdata;
        axis_out_9_tvalid = axis_in_5_tvalid;
        axis_out_9_tdest = axis_in_5_tdest;
        axis_out_9_tid = axis_in_5_tid;
    end else
    if (axis_in_6_tdest == 9) begin
        // Connect input port 6 to output port 9
        axis_out_9_tdata = axis_in_6_tdata;
        axis_out_9_tvalid = axis_in_6_tvalid;
        axis_out_9_tdest = axis_in_6_tdest;
        axis_out_9_tid = axis_in_6_tid;
    end else
    if (axis_in_7_tdest == 9) begin
        // Connect input port 7 to output port 9
        axis_out_9_tdata = axis_in_7_tdata;
        axis_out_9_tvalid = axis_in_7_tvalid;
        axis_out_9_tdest = axis_in_7_tdest;
        axis_out_9_tid = axis_in_7_tid;
    end else
    if (axis_in_8_tdest == 9) begin
        // Connect input port 8 to output port 9
        axis_out_9_tdata = axis_in_8_tdata;
        axis_out_9_tvalid = axis_in_8_tvalid;
        axis_out_9_tdest = axis_in_8_tdest;
        axis_out_9_tid = axis_in_8_tid;
    end else
    if (axis_in_9_tdest == 9) begin
        // Connect input port 9 to output port 9
        axis_out_9_tdata = axis_in_9_tdata;
        axis_out_9_tvalid = axis_in_9_tvalid;
        axis_out_9_tdest = axis_in_9_tdest;
        axis_out_9_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 9) begin
        // Connect input port 10 to output port 9
        axis_out_9_tdata = axis_in_10_tdata;
        axis_out_9_tvalid = axis_in_10_tvalid;
        axis_out_9_tdest = axis_in_10_tdest;
        axis_out_9_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 9) begin
        // Connect input port 11 to output port 9
        axis_out_9_tdata = axis_in_11_tdata;
        axis_out_9_tvalid = axis_in_11_tvalid;
        axis_out_9_tdest = axis_in_11_tdest;
        axis_out_9_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 9) begin
        // Connect input port 12 to output port 9
        axis_out_9_tdata = axis_in_12_tdata;
        axis_out_9_tvalid = axis_in_12_tvalid;
        axis_out_9_tdest = axis_in_12_tdest;
        axis_out_9_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
// Output 10 handling
always @(*) begin    
    if (axis_in_0_tdest == 10) begin
        // Connect input port 0 to output port 10
    ...
    if (axis_in_1_tdest == 10) begin
        // Connect input port 1 to output port 10
        axis_out_10_tdata = axis_in_1_tdata;
        axis_out_10_tvalid = axis_in_1_tvalid;
        axis_out_10_tdest = axis_in_1_tdest;
        axis_out_10_tid = axis_in_1_tid;
    end else
    if (axis_in_2_tdest == 10) begin
        // Connect input port 2 to output port 10
        axis_out_10_tdata = axis_in_2_tdata;
        axis_out_10_tvalid = axis_in_2_tvalid;
        axis_out_10_tdest = axis_in_2_tdest;
        axis_out_10_tid = axis_in_2_tid;
    end else
    if (axis_in_3_tdest == 10) begin
        // Connect input port 3 to output port 10
        axis_out_10_tdata = axis_in_3_tdata;
        axis_out_10_tvalid = axis_in_3_tvalid;
        axis_out_10_tdest = axis_in_3_tdest;
        axis_out_10_tid = axis_in_3_tid;
    end else
    if (axis_in_4_tdest == 10) begin
        // Connect input port 4 to output port 10
        axis_out_10_tdata = axis_in_4_tdata;
        axis_out_10_tvalid = axis_in_4_tvalid;
        axis_out_10_tdest = axis_in_4_tdest;
        axis_out_10_tid = axis_in_4_tid;
    end else
    if (axis_in_5_tdest == 10) begin
        // Connect input port 5 to output port 10
        axis_out_10_tdata = axis_in_5_tdata;
        axis_out_10_tvalid = axis_in_5_tvalid;
        axis_out_10_tdest = axis_in_5_tdest;
        axis_out_10_tid = axis_in_5_tid;
    end else
    if (axis_in_6_tdest == 10) begin
        // Connect input port 6 to output port 10
        axis_out_10_tdata = axis_in_6_tdata;
        axis_out_10_tvalid = axis_in_6_tvalid;
        axis_out_10_tdest = axis_in_6_tdest;
        axis_out_10_tid = axis_in_6_tid;
    end else
    if (axis_in_7_tdest == 10) begin
        // Connect input port 7 to output port 10
        axis_out_10_tdata = axis_in_7_tdata;
        axis_out_10_tvalid = axis_in_7_tvalid;
        axis_out_10_tdest = axis_in_7_tdest;
        axis_out_10_tid = axis_in_7_tid;
    end else
    if (axis_in_8_tdest == 10) begin
        // Connect input port 8 to output port 10
        axis_out_10_tdata = axis_in_8_tdata;
        axis_out_10_tvalid = axis_in_8_tvalid;
        axis_out_10_tdest = axis_in_8_tdest;
        axis_out_10_tid = axis_in_8_tid;
    end else
    if (axis_in_9_tdest == 10) begin
        // Connect input port 9 to output port 10
        axis_out_10_tdata = axis_in_9_tdata;
        axis_out_10_tvalid = axis_in_9_tvalid;
        axis_out_10_tdest = axis_in_9_tdest;
        axis_out_10_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 10) begin
        // Connect input port 10 to output port 10
        axis_out_10_tdata = axis_in_10_tdata;
        axis_out_10_tvalid = axis_in_10_tvalid;
        axis_out_10_tdest = axis_in_10_tdest;
        axis_out_10_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 10) begin
        // Connect input port 11 to output port 10
        axis_out_10_tdata = axis_in_11_tdata;
        axis_out_10_tvalid = axis_in_11_tvalid;
        axis_out_10_tdest = axis_in_11_tdest;
        axis_out_10_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 10) begin
        // Connect input port 12 to output port 10
        axis_out_10_tdata = axis_in_12_tdata;
        axis_out_10_tvalid = axis_in_12_tvalid;
        axis_out_10_tdest = axis_in_12_tdest;
        axis_out_10_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
// Output 11 handling
always @(*) begin    
    if (axis_in_0_tdest == 11) begin
        // Connect input port 0 to output port 11
    ...
    if (axis_in_1_tdest == 11) begin
        // Connect input port 1 to output port 11
        axis_out_11_tdata = axis_in_1_tdata;
        axis_out_11_tvalid = axis_in_1_tvalid;
        axis_out_11_tdest = axis_in_1_tdest;
        axis_out_11_tid = axis_in_1_tid;
    end else
    if (axis_in_2_tdest == 11) begin
        // Connect input port 2 to output port 11
        axis_out_11_tdata = axis_in_2_tdata;
        axis_out_11_tvalid = axis_in_2_tvalid;
        axis_out_11_tdest = axis_in_2_tdest;
        axis_out_11_tid = axis_in_2_tid;
    end else
    if (axis_in_3_tdest == 11) begin
        // Connect input port 3 to output port 11
        axis_out_11_tdata = axis_in_3_tdata;
        axis_out_11_tvalid = axis_in_3_tvalid;
        axis_out_11_tdest = axis_in_3_tdest;
        axis_out_11_tid = axis_in_3_tid;
    end else
    if (axis_in_4_tdest == 11) begin
        // Connect input port 4 to output port 11
        axis_out_11_tdata = axis_in_4_tdata;
        axis_out_11_tvalid = axis_in_4_tvalid;
        axis_out_11_tdest = axis_in_4_tdest;
        axis_out_11_tid = axis_in_4_tid;
    end else
    if (axis_in_5_tdest == 11) begin
        // Connect input port 5 to output port 11
        axis_out_11_tdata = axis_in_5_tdata;
        axis_out_11_tvalid = axis_in_5_tvalid;
        axis_out_11_tdest = axis_in_5_tdest;
        axis_out_11_tid = axis_in_5_tid;
    end else
    if (axis_in_6_tdest == 11) begin
        // Connect input port 6 to output port 11
        axis_out_11_tdata = axis_in_6_tdata;
        axis_out_11_tvalid = axis_in_6_tvalid;
        axis_out_11_tdest = axis_in_6_tdest;
        axis_out_11_tid = axis_in_6_tid;
    end else
    if (axis_in_7_tdest == 11) begin
        // Connect input port 7 to output port 11
        axis_out_11_tdata = axis_in_7_tdata;
        axis_out_11_tvalid = axis_in_7_tvalid;
        axis_out_11_tdest = axis_in_7_tdest;
        axis_out_11_tid = axis_in_7_tid;
    end else
    if (axis_in_8_tdest == 11) begin
        // Connect input port 8 to output port 11
        axis_out_11_tdata = axis_in_8_tdata;
        axis_out_11_tvalid = axis_in_8_tvalid;
        axis_out_11_tdest = axis_in_8_tdest;
        axis_out_11_tid = axis_in_8_tid;
    end else
    if (axis_in_9_tdest == 11) begin
        // Connect input port 9 to output port 11
        axis_out_11_tdata = axis_in_9_tdata;
        axis_out_11_tvalid = axis_in_9_tvalid;
        axis_out_11_tdest = axis_in_9_tdest;
        axis_out_11_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 11) begin
        // Connect input port 10 to output port 11
        axis_out_11_tdata = axis_in_10_tdata;
        axis_out_11_tvalid = axis_in_10_tvalid;
        axis_out_11_tdest = axis_in_10_tdest;
        axis_out_11_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 11) begin
        // Connect input port 11 to output port 11
        axis_out_11_tdata = axis_in_11_tdata;
        axis_out_11_tvalid = axis_in_11_tvalid;
        axis_out_11_tdest = axis_in_11_tdest;
        axis_out_11_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 11) begin
        // Connect input port 12 to output port 11
        axis_out_11_tdata = axis_in_12_tdata;
        axis_out_11_tvalid = axis_in_12_tvalid;
        axis_out_11_tdest = axis_in_12_tdest;
        axis_out_11_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
...
// Output 12 handling
always @(*) begin    
    if (axis_in_0_tdest == 12) begin
        // Connect input port 0 to output port 12
    ...
    if (axis_in_1_tdest == 12) begin
        // Connect input port 1 to output port 12
        axis_out_12_tdata = axis_in_1_tdata;
        axis_out_12_tvalid = axis_in_1_tvalid;
        axis_out_12_tdest = axis_in_1_tdest;
        axis_out_12_tid = axis_in_1_tid;
    end else
    if (axis_in_2_tdest == 12) begin
        // Connect input port 2 to output port 12
        axis_out_12_tdata = axis_in_2_tdata;
        axis_out_12_tvalid = axis_in_2_tvalid;
        axis_out_12_tdest = axis_in_2_tdest;
        axis_out_12_tid = axis_in_2_tid;
    end else
    if (axis_in_3_tdest == 12) begin
        // Connect input port 3 to output port 12
        axis_out_12_tdata = axis_in_3_tdata;
        axis_out_12_tvalid = axis_in_3_tvalid;
        axis_out_12_tdest = axis_in_3_tdest;
        axis_out_12_tid = axis_in_3_tid;
    end else
    if (axis_in_4_tdest == 12) begin
        // Connect input port 4 to output port 12
        axis_out_12_tdata = axis_in_4_tdata;
        axis_out_12_tvalid = axis_in_4_tvalid;
        axis_out_12_tdest = axis_in_4_tdest;
        axis_out_12_tid = axis_in_4_tid;
    end else
    if (axis_in_5_tdest == 12) begin
        // Connect input port 5 to output port 12
        axis_out_12_tdata = axis_in_5_tdata;
        axis_out_12_tvalid = axis_in_5_tvalid;
        axis_out_12_tdest = axis_in_5_tdest;
        axis_out_12_tid = axis_in_5_tid;
    end else
    if (axis_in_6_tdest == 12) begin
        // Connect input port 6 to output port 12
        axis_out_12_tdata = axis_in_6_tdata;
        axis_out_12_tvalid = axis_in_6_tvalid;
        axis_out_12_tdest = axis_in_6_tdest;
        axis_out_12_tid = axis_in_6_tid;
    end else
    if (axis_in_7_tdest == 12) begin
        // Connect input port 7 to output port 12
        axis_out_12_tdata = axis_in_7_tdata;
        axis_out_12_tvalid = axis_in_7_tvalid;
        axis_out_12_tdest = axis_in_7_tdest;
        axis_out_12_tid = axis_in_7_tid;
    end else
    if (axis_in_8_tdest == 12) begin
        // Connect input port 8 to output port 12
        axis_out_12_tdata = axis_in_8_tdata;
        axis_out_12_tvalid = axis_in_8_tvalid;
        axis_out_12_tdest = axis_in_8_tdest;
        axis_out_12_tid = axis_in_8_tid;
    end else
    if (axis_in_9_tdest == 12) begin
        // Connect input port 9 to output port 12
        axis_out_12_tdata = axis_in_9_tdata;
        axis_out_12_tvalid = axis_in_9_tvalid;
        axis_out_12_tdest = axis_in_9_tdest;
        axis_out_12_tid = axis_in_9_tid;
    end else
    if (axis_in_10_tdest == 12) begin
        // Connect input port 10 to output port 12
        axis_out_12_tdata = axis_in_10_tdata;
        axis_out_12_tvalid = axis_in_10_tvalid;
        axis_out_12_tdest = axis_in_10_tdest;
        axis_out_12_tid = axis_in_10_tid;
    end else
    if (axis_in_11_tdest == 12) begin
        // Connect input port 11 to output port 12
        axis_out_12_tdata = axis_in_11_tdata;
        axis_out_12_tvalid = axis_in_11_tvalid;
        axis_out_12_tdest = axis_in_11_tdest;
        axis_out_12_tid = axis_in_11_tid;
    end else
    if (axis_in_12_tdest == 12) begin
        // Connect input port 12 to output port 12
        axis_out_12_tdata = axis_in_12_tdata;
        axis_out_12_tvalid = axis_in_12_tvalid;
        axis_out_12_tdest = axis_in_12_tdest;
        axis_out_12_tid = axis_in_12_tid;
    end else
    begin 
        // Default: no valid data
