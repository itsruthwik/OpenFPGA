...
always @(*) begin
    ...
    if (axis_in_0_tvalid && axis_in_0_tdest < 7) begin
    ...
    if (axis_in_1_tvalid && axis_in_1_tdest < 7) begin
    ...
    if (axis_in_2_tvalid && axis_in_2_tdest < 7) begin
    ...
    if (axis_in_3_tvalid && axis_in_3_tdest < 7) begin
    ...
    if (axis_in_4_tvalid && axis_in_4_tdest < 7) begin
    ...
    if (axis_in_5_tvalid && axis_in_5_tdest < 7) begin
    ...
    if (axis_in_6_tvalid && axis_in_6_tdest < 7) begin
