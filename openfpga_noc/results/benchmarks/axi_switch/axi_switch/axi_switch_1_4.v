...
always @(*) begin
    ...
    if (axis_in_0_tvalid && axis_in_0_tdest < 5) begin
    ...
    if (axis_in_1_tvalid && axis_in_1_tdest < 5) begin
    ...
    if (axis_in_2_tvalid && axis_in_2_tdest < 5) begin
    ...
    if (axis_in_3_tvalid && axis_in_3_tdest < 5) begin
    ...
    if (axis_in_4_tvalid && axis_in_4_tdest < 5) begin
