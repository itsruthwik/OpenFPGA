...
`include "/mnt/vault1/rsunketa/OpenFPGA/openfpga_noc/results/benchmarks/axi_switch/axi_switch_1_18.v"
...
// PE 3 signals
    ...
    output                     pe3_in_ready,
// PE 4 signals
    output [127:0] pe4_out_data,
    output                     pe4_out_valid,
    output [3:0] pe4_out_dest,
    output [1:0]   pe4_out_id,
    output                     pe4_in_ready,
// PE 5 signals
    output [127:0] pe5_out_data,
    output                     pe5_out_valid,
    output [3:0] pe5_out_dest,
    output [1:0]   pe5_out_id,
    output                     pe5_in_ready,
// PE 6 signals
    output [127:0] pe6_out_data,
    output                     pe6_out_valid,
    output [3:0] pe6_out_dest,
    output [1:0]   pe6_out_id,
    output                     pe6_in_ready,
// PE 7 signals
    output [127:0] pe7_out_data,
    output                     pe7_out_valid,
    output [3:0] pe7_out_dest,
    output [1:0]   pe7_out_id,
    output                     pe7_in_ready,
// PE 8 signals
    output [127:0] pe8_out_data,
    output                     pe8_out_valid,
    output [3:0] pe8_out_dest,
    output [1:0]   pe8_out_id,
    output                     pe8_in_ready,
// PE 9 signals
    output [127:0] pe9_out_data,
    output                     pe9_out_valid,
    output [3:0] pe9_out_dest,
    output [1:0]   pe9_out_id,
    output                     pe9_in_ready,
// PE 10 signals
    output [127:0] pe10_out_data,
    output                     pe10_out_valid,
    output [3:0] pe10_out_dest,
    output [1:0]   pe10_out_id,
    output                     pe10_in_ready,
// PE 11 signals
    output [127:0] pe11_out_data,
    output                     pe11_out_valid,
    output [3:0] pe11_out_dest,
    output [1:0]   pe11_out_id,
    output                     pe11_in_ready,
// PE 12 signals
    output [127:0] pe12_out_data,
    output                     pe12_out_valid,
    output [3:0] pe12_out_dest,
    output [1:0]   pe12_out_id,
    output                     pe12_in_ready,
// PE 13 signals
    output [127:0] pe13_out_data,
    output                     pe13_out_valid,
    output [3:0] pe13_out_dest,
    output [1:0]   pe13_out_id,
    output                     pe13_in_ready,
// PE 14 signals
    output [127:0] pe14_out_data,
    output                     pe14_out_valid,
    output [3:0] pe14_out_dest,
    output [1:0]   pe14_out_id,
    output                     pe14_in_ready,
// PE 15 signals
    output [127:0] pe15_out_data,
    output                     pe15_out_valid,
    output [3:0] pe15_out_dest,
    output [1:0]   pe15_out_id,
    output                     pe15_in_ready,
...
// PE 12 signals
    // wire [127:0] pe12_out_data;
    // wire                     pe12_out_valid;
    wire                     pe12_out_ready;
    // wire [3:0] pe12_out_dest;
    // wire [1:0]   pe12_out_id;
    
    wire [127:0] pe12_in_data;
    wire                     pe12_in_valid;
    // wire                     pe12_in_ready;
    wire [3:0] pe12_in_dest;
    wire [1:0]   pe12_in_id;

// PE 13 signals
    // wire [127:0] pe13_out_data;
    // wire                     pe13_out_valid;
    wire                     pe13_out_ready;
    // wire [3:0] pe13_out_dest;
    // wire [1:0]   pe13_out_id;
    
    wire [127:0] pe13_in_data;
    wire                     pe13_in_valid;
    // wire                     pe13_in_ready;
    wire [3:0] pe13_in_dest;
    wire [1:0]   pe13_in_id;

// PE 14 signals
    // wire [127:0] pe14_out_data;
    // wire                     pe14_out_valid;
    wire                     pe14_out_ready;
    // wire [3:0] pe14_out_dest;
    // wire [1:0]   pe14_out_id;
    
    wire [127:0] pe14_in_data;
    wire                     pe14_in_valid;
    // wire                     pe14_in_ready;
    wire [3:0] pe14_in_dest;
    wire [1:0]   pe14_in_id;

// PE 15 signals
    // wire [127:0] pe15_out_data;
    // wire                     pe15_out_valid;
    wire                     pe15_out_ready;
    // wire [3:0] pe15_out_dest;
    // wire [1:0]   pe15_out_id;
    
    wire [127:0] pe15_in_data;
    wire                     pe15_in_valid;
    // wire                     pe15_in_ready;
    wire [3:0] pe15_in_dest;
    wire [1:0]   pe15_in_id;
...
// PE 4 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_4 (
        ...
        .axis_in_data(pe4_in_data),
        .axis_in_valid(pe4_in_valid),
        .axis_in_ready(pe4_in_ready),
        // .inp_dest(pe4_in_dest),
        .axis_in_id(pe4_in_id),
        // .axis_in_last(pe4_in_last),

        .axis_out_data(pe4_out_data),
        .axis_out_valid(pe4_out_valid),
        .axis_out_ready(pe4_out_ready),
        // .axis_out_dest(pe4_out_dest),
        .axis_out_id(pe4_out_id),
        .axis_out_id(pe4_out_id),
        // .axis_out_last(pe4_out_last)
...
// PE 5 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_5 (
        ...
        .axis_in_data(pe5_in_data),
        .axis_in_valid(pe5_in_valid),
        .axis_in_ready(pe5_in_ready),
        // .inp_dest(pe5_in_dest),
        .axis_in_id(pe5_in_id),
        // .axis_in_last(pe5_in_last),

        .axis_out_data(pe5_out_data),
        .axis_out_valid(pe5_out_valid),
        .axis_out_ready(pe5_out_ready),
        // .axis_out_dest(pe5_out_dest),
        .axis_out_id(pe5_out_id),
        .axis_out_id(pe5_out_id),
        // .axis_out_last(pe5_out_last)
...
// PE 6 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_6 (
        ...
        .axis_in_data(pe6_in_data),
        .axis_in_valid(pe6_in_valid),
        .axis_in_ready(pe6_in_ready),
        // .inp_dest(pe6_in_dest),
        .axis_in_id(pe6_in_id),
        // .axis_in_last(pe6_in_last),

        .axis_out_data(pe6_out_data),
        .axis_out_valid(pe6_out_valid),
        .axis_out_ready(pe6_out_ready),
        // .axis_out_dest(pe6_out_dest),
        .axis_out_id(pe6_out_id),
        .axis_out_id(pe6_out_id),
        // .axis_out_last(pe6_out_last)
...
// PE 7 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_7 (
        ...
        .axis_in_data(pe7_in_data),
        .axis_in_valid(pe7_in_valid),
        .axis_in_ready(pe7_in_ready),
        // .inp_dest(pe7_in_dest),
        .axis_in_id(pe7_in_id),
        // .axis_in_last(pe7_in_last),

        .axis_out_data(pe7_out_data),
        .axis_out_valid(pe7_out_valid),
        .axis_out_ready(pe7_out_ready),
        // .axis_out_dest(pe7_out_dest),
        .axis_out_id(pe7_out_id),
        .axis_out_id(pe7_out_id),
        // .axis_out_last(pe7_out_last)
...
// PE 8 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_8 (
        ...
        .axis_in_data(pe8_in_data),
        .axis_in_valid(pe8_in_valid),
        .axis_in_ready(pe8_in_ready),
        // .inp_dest(pe8_in_dest),
        .axis_in_id(pe8_in_id),
        // .axis_in_last(pe8_in_last),

        .axis_out_data(pe8_out_data),
        .axis_out_valid(pe8_out_valid),
        .axis_out_ready(pe8_out_ready),
        // .axis_out_dest(pe8_out_dest),
        .axis_out_id(pe8_out_id),
        .axis_out_id(pe8_out_id),
        // .axis_out_last(pe8_out_last)
...
// PE 9 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_9 (
        ...
        .axis_in_data(pe9_in_data),
        .axis_in_valid(pe9_in_valid),
        .axis_in_ready(pe9_in_ready),
        // .inp_dest(pe9_in_dest),
        .axis_in_id(pe9_in_id),
        // .axis_in_last(pe9_in_last),

        .axis_out_data(pe9_out_data),
        .axis_out_valid(pe9_out_valid),
        .axis_out_ready(pe9_out_ready),
        // .axis_out_dest(pe9_out_dest),
        .axis_out_id(pe9_out_id),
        .axis_out_id(pe9_out_id),
        // .axis_out_last(pe9_out_last)
...
// PE 10 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_10 (
        ...
        .axis_in_data(pe10_in_data),
        .axis_in_valid(pe10_in_valid),
        .axis_in_ready(pe10_in_ready),
        // .inp_dest(pe10_in_dest),
        .axis_in_id(pe10_in_id),
        // .axis_in_last(pe10_in_last),

        .axis_out_data(pe10_out_data),
        .axis_out_valid(pe10_out_valid),
        .axis_out_ready(pe10_out_ready),
        // .axis_out_dest(pe10_out_dest),
        .axis_out_id(pe10_out_id),
        .axis_out_id(pe10_out_id),
        // .axis_out_last(pe10_out_last)
...
// PE 11 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_11 (
        ...
        .axis_in_data(pe11_in_data),
        .axis_in_valid(pe11_in_valid),
        .axis_in_ready(pe11_in_ready),
        // .inp_dest(pe11_in_dest),
        .axis_in_id(pe11_in_id),
        // .axis_in_last(pe11_in_last),

        .axis_out_data(pe11_out_data),
        .axis_out_valid(pe11_out_valid),
        .axis_out_ready(pe11_out_ready),
        // .axis_out_dest(pe11_out_dest),
        .axis_out_id(pe11_out_id),
        .axis_out_id(pe11_out_id),
        // .axis_out_last(pe11_out_last)
...
// PE 12 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_12 (
        .clk(clk),
        .reset(reset),
        
        .axis_in_data(pe12_in_data),
        .axis_in_valid(pe12_in_valid),
        .axis_in_ready(pe12_in_ready),
        // .inp_dest(pe12_in_dest),
        .axis_in_id(pe12_in_id),
        // .axis_in_last(pe12_in_last),

        .axis_out_data(pe12_out_data),
        .axis_out_valid(pe12_out_valid),
        .axis_out_ready(pe12_out_ready),
        // .axis_out_dest(pe12_out_dest),
        .axis_out_id(pe12_out_id),
        .axis_out_id(pe12_out_id),
        // .axis_out_last(pe12_out_last)

        // .test_input(test_input[51:48]),
        // .test_output(test_output[51:48])
    );

// PE 13 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_13 (
        .clk(clk),
        .reset(reset),
        
        .axis_in_data(pe13_in_data),
        .axis_in_valid(pe13_in_valid),
        .axis_in_ready(pe13_in_ready),
        // .inp_dest(pe13_in_dest),
        .axis_in_id(pe13_in_id),
        // .axis_in_last(pe13_in_last),

        .axis_out_data(pe13_out_data),
        .axis_out_valid(pe13_out_valid),
        .axis_out_ready(pe13_out_ready),
        // .axis_out_dest(pe13_out_dest),
        .axis_out_id(pe13_out_id),
        .axis_out_id(pe13_out_id),
        // .axis_out_last(pe13_out_last)

        // .test_input(test_input[55:52]),
        // .test_output(test_output[55:52])
    );

// PE 14 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_14 (
        .clk(clk),
        .reset(reset),
        
        .axis_in_data(pe14_in_data),
        .axis_in_valid(pe14_in_valid),
        .axis_in_ready(pe14_in_ready),
        // .inp_dest(pe14_in_dest),
        .axis_in_id(pe14_in_id),
        // .axis_in_last(pe14_in_last),

        .axis_out_data(pe14_out_data),
        .axis_out_valid(pe14_out_valid),
        .axis_out_ready(pe14_out_ready),
        // .axis_out_dest(pe14_out_dest),
        .axis_out_id(pe14_out_id),
        .axis_out_id(pe14_out_id),
        // .axis_out_last(pe14_out_last)

        // .test_input(test_input[59:56]),
        // .test_output(test_output[59:56])
    );

// PE 15 instantiation
    (* keep = "true" *) koios_axi_wrap pe_inst_15 (
        .clk(clk),
        .reset(reset),
        
        .axis_in_data(pe15_in_data),
        .axis_in_valid(pe15_in_valid),
        .axis_in_ready(pe15_in_ready),
        // .inp_dest(pe15_in_dest),
        .axis_in_id(pe15_in_id),
        // .axis_in_last(pe15_in_last),

        .axis_out_data(pe15_out_data),
        .axis_out_valid(pe15_out_valid),
        .axis_out_ready(pe15_out_ready),
        // .axis_out_dest(pe15_out_dest),
        .axis_out_id(pe15_out_id),
        .axis_out_id(pe15_out_id),
        // .axis_out_last(pe15_out_last)

        // .test_input(test_input[63:60]),
        // .test_output(test_output[63:60])
    );
...
//     );
    ...
    wire [127:0] switch_in_14_tdata;
    wire                     switch_in_14_tvalid;
    wire [3:0] switch_in_14_tdest;
    wire [1:0]   switch_in_14_tid;
    wire                     switch_in_14_tready;

    wire [127:0] switch_out_14_tdata;
    wire                     switch_out_14_tvalid;
    wire [3:0] switch_out_14_tdest;
    wire [1:0]   switch_out_14_tid;
    wire                     switch_out_14_tready;


    wire [127:0] switch_in_15_tdata;
    wire                     switch_in_15_tvalid;
    wire [3:0] switch_in_15_tdest;
    wire [1:0]   switch_in_15_tid;
    wire                     switch_in_15_tready;

    wire [127:0] switch_out_15_tdata;
    wire                     switch_out_15_tvalid;
    wire [3:0] switch_out_15_tdest;
    wire [1:0]   switch_out_15_tid;
    wire                     switch_out_15_tready;


    wire [127:0] switch_in_16_tdata;
    wire                     switch_in_16_tvalid;
    wire [3:0] switch_in_16_tdest;
    wire [1:0]   switch_in_16_tid;
    wire                     switch_in_16_tready;

    wire [127:0] switch_out_16_tdata;
    wire                     switch_out_16_tvalid;
    wire [3:0] switch_out_16_tdest;
    wire [1:0]   switch_out_16_tid;
    wire                     switch_out_16_tready;


    wire [127:0] switch_in_17_tdata;
    wire                     switch_in_17_tvalid;
    wire [3:0] switch_in_17_tdest;
    wire [1:0]   switch_in_17_tid;
    wire                     switch_in_17_tready;

    wire [127:0] switch_out_17_tdata;
    wire                     switch_out_17_tvalid;
    wire [3:0] switch_out_17_tdest;
    wire [1:0]   switch_out_17_tid;
    wire                     switch_out_17_tready;


    wire [127:0] switch_in_18_tdata;
    wire                     switch_in_18_tvalid;
    wire [3:0] switch_in_18_tdest;
    wire [1:0]   switch_in_18_tid;
    wire                     switch_in_18_tready;

    wire [127:0] switch_out_18_tdata;
    wire                     switch_out_18_tvalid;
    wire [3:0] switch_out_18_tdest;
    wire [1:0]   switch_out_18_tid;
    wire                     switch_out_18_tready;



(* keep = "true" *) axis_switch_1_to_18 switch_inst (
    .clk(clk),
    .rst(reset),
    ...
    // port 14 inputs
    .axis_in_14_tdata(switch_in_14_tdata),
    .axis_in_14_tvalid(switch_in_14_tvalid),
    .axis_in_14_tdest(switch_in_14_tdest),
    .axis_in_14_tid(switch_in_14_tid),
    .axis_in_14_tready(switch_in_14_tready),
    // port 14 outputs
    .axis_out_14_tdata(switch_out_14_tdata),
    .axis_out_14_tvalid(switch_out_14_tvalid),
    .axis_out_14_tdest(switch_out_14_tdest),
    .axis_out_14_tid(switch_out_14_tid),
    .axis_out_14_tready(switch_out_14_tready),

    // port 15 inputs
    .axis_in_15_tdata(switch_in_15_tdata),
    .axis_in_15_tvalid(switch_in_15_tvalid),
    .axis_in_15_tdest(switch_in_15_tdest),
    .axis_in_15_tid(switch_in_15_tid),
    .axis_in_15_tready(switch_in_15_tready),
    // port 15 outputs
    .axis_out_15_tdata(switch_out_15_tdata),
    .axis_out_15_tvalid(switch_out_15_tvalid),
    .axis_out_15_tdest(switch_out_15_tdest),
    .axis_out_15_tid(switch_out_15_tid),
    .axis_out_15_tready(switch_out_15_tready),

    // port 16 inputs
    .axis_in_16_tdata(switch_in_16_tdata),
    .axis_in_16_tvalid(switch_in_16_tvalid),
    .axis_in_16_tdest(switch_in_16_tdest),
    .axis_in_16_tid(switch_in_16_tid),
    .axis_in_16_tready(switch_in_16_tready),
    // port 16 outputs
    .axis_out_16_tdata(switch_out_16_tdata),
    .axis_out_16_tvalid(switch_out_16_tvalid),
    .axis_out_16_tdest(switch_out_16_tdest),
    .axis_out_16_tid(switch_out_16_tid),
    .axis_out_16_tready(switch_out_16_tready),

    // port 17 inputs
    .axis_in_17_tdata(switch_in_17_tdata),
    .axis_in_17_tvalid(switch_in_17_tvalid),
    .axis_in_17_tdest(switch_in_17_tdest),
    .axis_in_17_tid(switch_in_17_tid),
    .axis_in_17_tready(switch_in_17_tready),
    // port 17 outputs
    .axis_out_17_tdata(switch_out_17_tdata),
    .axis_out_17_tvalid(switch_out_17_tvalid),
    .axis_out_17_tdest(switch_out_17_tdest),
    .axis_out_17_tid(switch_out_17_tid),
    .axis_out_17_tready(switch_out_17_tready),

    // port 18 inputs
    .axis_in_18_tdata(switch_in_18_tdata),
    .axis_in_18_tvalid(switch_in_18_tvalid),
    .axis_in_18_tdest(switch_in_18_tdest),
    .axis_in_18_tid(switch_in_18_tid),
    .axis_in_18_tready(switch_in_18_tready),
    // port 18 outputs
    .axis_out_18_tdata(switch_out_18_tdata),
    .axis_out_18_tvalid(switch_out_18_tvalid),
    .axis_out_18_tdest(switch_out_18_tdest),
    .axis_out_18_tid(switch_out_18_tid),
    .axis_out_18_tready(switch_out_18_tready),
    ...
    // Connect PE 12 to switch
    assign switch_in_13_tdata = pe12_out_data;
    assign switch_in_13_tvalid = pe12_out_valid;
    assign switch_in_13_tdest = pe12_out_dest;
    assign switch_in_13_tid = pe12_out_id;
    assign pe12_out_ready = switch_in_13_tready;
    // Connect switch output to PE 12
    assign pe12_in_data = switch_out_13_tdata;
    assign pe12_in_valid = switch_out_13_tvalid;
    assign pe12_in_dest = switch_out_13_tdest;
    assign pe12_in_id = switch_out_13_tid;
    assign switch_out_13_tready = pe12_in_ready; 

    // Connect PE 13 to switch
    assign switch_in_14_tdata = pe13_out_data;
    assign switch_in_14_tvalid = pe13_out_valid;
    assign switch_in_14_tdest = pe13_out_dest;
    assign switch_in_14_tid = pe13_out_id;
    assign pe13_out_ready = switch_in_14_tready;
    // Connect switch output to PE 13
    assign pe13_in_data = switch_out_14_tdata;
    assign pe13_in_valid = switch_out_14_tvalid;
    assign pe13_in_dest = switch_out_14_tdest;
    assign pe13_in_id = switch_out_14_tid;
    assign switch_out_14_tready = pe13_in_ready; 

    // Connect PE 14 to switch
    assign switch_in_15_tdata = pe14_out_data;
    assign switch_in_15_tvalid = pe14_out_valid;
    assign switch_in_15_tdest = pe14_out_dest;
    assign switch_in_15_tid = pe14_out_id;
    assign pe14_out_ready = switch_in_15_tready;
    // Connect switch output to PE 14
    assign pe14_in_data = switch_out_15_tdata;
    assign pe14_in_valid = switch_out_15_tvalid;
    assign pe14_in_dest = switch_out_15_tdest;
    assign pe14_in_id = switch_out_15_tid;
    assign switch_out_15_tready = pe14_in_ready; 

    // Connect PE 15 to switch
    assign switch_in_16_tdata = pe15_out_data;
    assign switch_in_16_tvalid = pe15_out_valid;
    assign switch_in_16_tdest = pe15_out_dest;
    assign switch_in_16_tid = pe15_out_id;
    assign pe15_out_ready = switch_in_16_tready;
    // Connect switch output to PE 15
    assign pe15_in_data = switch_out_16_tdata;
    assign pe15_in_valid = switch_out_16_tvalid;
    assign pe15_in_dest = switch_out_16_tdest;
    assign pe15_in_id = switch_out_16_tid;
    assign switch_out_16_tready = pe15_in_ready; 


assign switch_in_17_tdata = inp_data;
assign switch_in_17_tvalid = inp_valid;
assign switch_in_17_tdest = inp_dest;
assign switch_in_17_tid = inp_id;
assign inp_ready = switch_in_17_tready;

assign outp_data = switch_out_17_tdata;
assign outp_valid = switch_out_17_tvalid;
assign outp_dest = switch_out_17_tdest;
assign outp_id = switch_out_17_tid;
assign switch_out_17_tready = outp_ready;
...
// axi_eth
   (* keep = "true" *) axi_hbm hbm_inst (
        ...
        .axis_in_tvalid(switch_out_18_tvalid),
        .axis_in_tready(switch_out_18_tready),
        .axis_in_tdata(switch_out_18_tdata),
        .axis_in_tid(switch_out_18_tid),
        .axis_in_tdest(switch_out_18_tdest),
        .axis_in_tlast(in_tlast[1]),

        .axis_out_tvalid(switch_in_18_tvalid),
        .axis_out_tready(switch_in_18_tready),
        .axis_out_tdata(switch_in_18_tdata),
        .axis_out_tid(switch_in_18_tid),
        .axis_out_tdest(switch_in_18_tdest),
