...
`include "/mnt/vault1/rsunketa/OpenFPGA/openfpga_noc/results/benchmarks/axi_switch/axi_switch_1_16.v"
...
// PE 13 signals
    ...
    input [55:0] test_input,
    output [55:0] test_output
);
...
assign switch_in_15_tdata = inp_data;
assign switch_in_15_tvalid = inp_valid;
assign switch_in_15_tdest = inp_dest;
assign switch_in_15_tid = inp_id;
assign inp_ready = switch_in_15_tready;

assign outp_data = switch_out_15_tdata;
assign outp_valid = switch_out_15_tvalid;
assign outp_dest = switch_out_15_tdest;
assign outp_id = switch_out_15_tid;
assign switch_out_15_tready = outp_ready;
...
// axi_eth
   (* keep = "true" *) axi_hbm hbm_inst (
        ...
        .axis_in_tvalid(switch_out_16_tvalid),
        .axis_in_tready(switch_out_16_tready),
        .axis_in_tdata(switch_out_16_tdata),
        .axis_in_tid(switch_out_16_tid),
        .axis_in_tdest(switch_out_16_tdest),
        .axis_in_tlast(in_tlast[1]),

        .axis_out_tvalid(switch_in_16_tvalid),
        .axis_out_tready(switch_in_16_tready),
        .axis_out_tdata(switch_in_16_tdata),
        .axis_out_tid(switch_in_16_tid),
        .axis_out_tdest(switch_in_16_tdest),
