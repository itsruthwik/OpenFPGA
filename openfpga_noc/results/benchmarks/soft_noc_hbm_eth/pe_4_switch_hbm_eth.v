...
`include "/mnt/vault1/rsunketa/OpenFPGA/openfpga_noc/results/benchmarks/axi_switch/axi_switch_1_6.v"
...
// axi_eth
   (* keep = "true" *) axi_hbm hbm_inst (
        ...
        .axis_in_tvalid(switch_out_6_tvalid),
        .axis_in_tready(switch_out_6_tready),
        .axis_in_tdata(switch_out_6_tdata),
        .axis_in_tid(switch_out_6_tid),
        .axis_in_tdest(switch_out_6_tdest),
        .axis_in_tlast(in_tlast[1]),

        .axis_out_tvalid(switch_in_6_tvalid),
        .axis_out_tready(switch_in_6_tready),
        .axis_out_tdata(switch_in_6_tdata),
        .axis_out_tid(switch_in_6_tid),
        .axis_out_tdest(switch_in_6_tdest),
