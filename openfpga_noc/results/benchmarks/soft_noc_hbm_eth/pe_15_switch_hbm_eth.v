...
`include "/mnt/vault1/rsunketa/OpenFPGA/openfpga_noc/results/benchmarks/axi_switch/axi_switch_1_17.v"
...
// PE 14 signals
    ...
    input [59:0] test_input,
    output [59:0] test_output
);
...
(* keep = "true" *) axis_switch_1_to_17 switch_inst (
    .clk(clk),
    .rst(reset),
...
assign switch_in_16_tdata = inp_data;
assign switch_in_16_tvalid = inp_valid;
assign switch_in_16_tdest = inp_dest;
assign switch_in_16_tid = inp_id;
assign inp_ready = switch_in_16_tready;

assign outp_data = switch_out_16_tdata;
assign outp_valid = switch_out_16_tvalid;
assign outp_dest = switch_out_16_tdest;
assign outp_id = switch_out_16_tid;
assign switch_out_16_tready = outp_ready;
...
// axi_eth
   (* keep = "true" *) axi_hbm hbm_inst (
        ...
        .axis_in_tvalid(switch_out_17_tvalid),
        .axis_in_tready(switch_out_17_tready),
        .axis_in_tdata(switch_out_17_tdata),
        .axis_in_tid(switch_out_17_tid),
        .axis_in_tdest(switch_out_17_tdest),
        .axis_in_tlast(in_tlast[1]),

        .axis_out_tvalid(switch_in_17_tvalid),
        .axis_out_tready(switch_in_17_tready),
        .axis_out_tdata(switch_in_17_tdata),
        .axis_out_tid(switch_in_17_tid),
        .axis_out_tdest(switch_in_17_tdest),
