...
`include "/mnt/vault1/rsunketa/OpenFPGA/openfpga-test-runs/000-push-button-flows/bench/axi_switch/axi_switch_1_8.v"
...
(* keep = "true" *) axis_switch_1_to_8 switch_inst (
    .clk(clk),
    .rst(reset),
